...
form Analyze duration and pitches from labeled segments in files
	...
	text textGrid_directory C:\Users\sprin\Desktop\test\test2\
	comment Full paths of the resulting text files:
	boolean need_interval_result 1
	text interval_result C:\Users\sprin\Desktop\test\test2\int.txt
...
if need_interval_result = 1
	...
	interval_titleline$ = "file_name,interval_label,interval_start,interval_end,interval_duration,word_label, word_start, word_end 'newline$'"
	...
	if need_interval_result = 1
		...
		for i from 1 to numberOfIntervals
			...
			if int_label$ <> ""
				...
				interval_resultline$ = "'tg_name$','int_label$','interval_start','interval_end','interval_duration','word_label$', 'word_start', 'word_end' 'newline$'"
