...
# point_titleline$ = "index, file_name, point_label, point_time 'newline$'"
point_titleline$ = "file_name, point_label, point_time 'newline$'"
...
for ifile to numberOfFiles
	...
	for j from 1 to numberOfPoints
		...
		point_resultline$ = "'tg_name$','point_label$','point_time' 'newline$'"
