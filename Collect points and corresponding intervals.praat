...
form Analyze duration and pitches from labeled segments in files
	...
	text textGrid_directory C:\Users\sprin\Desktop\Sing_Mandarin\不能说的秘密\new\
	comment Full paths of the resulting text files:
	text interval_result C:\Users\sprin\Desktop\Sing_Mandarin\不能说的秘密\new\int.txt
	text point_result C:\Users\sprin\Desktop\Sing_Mandarin\不能说的秘密\new\point.txt
